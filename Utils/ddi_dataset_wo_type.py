...
class BatchLoader:
    ...
    def collate_fn(self, batch):
        ...
        dummy_ddi_type=[i for i in range(len(y_true))if y_true[i]==1]
        cnm=[i for i in range(len(y_true))if y_true[i]==0]
        #print(y_true)
        ...
        return batch_1, batch_2, None, y_true,dummy_ddi_type,cnm
